...
//        boolean solved = solve(Options.getInstance().getDifficultyLevel(DifficultyType.EXTREME.ordinal()), null, false, null, true);
        boolean solved = solve(Options.getInstance().getDifficultyLevel(DifficultyType.EXTREME.ordinal()), null, false, true);
        steps = oldList;
        //sudoku = tmpSudoku;
        setSudoku(tmpSudoku);
        return solved;
...
//        boolean solved = solve(Options.getInstance().getDifficultyLevels()[DifficultyType.EXTREME.ordinal()], null, false, null, true);
        // TODO: 2019-07-06
//        boolean solved = solve(Options.getInstance().getDifficultyLevel(DifficultyType.EXTREME.ordinal()), null, false, null, false, stepConfigs, GameMode.PLAYING);
        boolean solved = solve(Options.getInstance().getDifficultyLevel(DifficultyType.EXTREME.ordinal()), null, false, false, stepConfigs);
        steps = oldList;
        //sudoku = tmpSudoku;
        setSudoku(tmpSudoku);
        return solved;
     ...
     */
    // TODO: 2019-07-06
//    public boolean solve(DifficultyLevel maxLevel, Sudoku tmpSudoku, boolean rejectTooLowScore, final SolverProgressDialog dlg) {
...
//        return solve(maxLevel, tmpSudoku, rejectTooLowScore, dlg, false);
        return solve(maxLevel, tmpSudoku, rejectTooLowScore, false);
    }
     ...
     */
    // TODO: 2019-07-06
//    public boolean solve(DifficultyLevel maxLevel, Sudoku tmpSudoku, boolean rejectTooLowScore, final SolverProgressDialog dlg, boolean singlesOnly) {
    public boolean solve(DifficultyLevel maxLevel, Sudoku tmpSudoku, boolean rejectTooLowScore, boolean singlesOnly) {
//        return solve(maxLevel, tmpSudoku, rejectTooLowScore, dlg, singlesOnly, Options.getInstance().solverSteps, GameMode.PLAYING);
        return solve(maxLevel, tmpSudoku, rejectTooLowScore, singlesOnly, Options.getInstance().solverSteps);
    }
     ...
     * @param maxLevel
     * @param tmpSudoku
     * @param rejectTooLowScore //     * @param dlg
     * @param singlesOnly
     * @param stepConfigs
     * @param gameMode
     * @return
     */
    // TODO: 2019-07-06
//    public boolean solve(DifficultyLevel maxLevel, Sudoku tmpSudoku, boolean rejectTooLowScore, final SolverProgressDialog dlg, boolean singlesOnly, StepConfig[] stepConfigs,
    public boolean solve(DifficultyLevel maxLevel, Sudoku tmpSudoku, boolean rejectTooLowScore, boolean singlesOnly, StepConfig[] stepConfigs) {
        if (tmpSudoku != null) {
            setSudoku(tmpSudoku);
        }
...
//                System.out.println("Step: " + step.toString(2));
                ...
                if (GameMode.PLAYING != GameMode.PLAYING && step.getType().getStepConfig().isEnabledTraining()) {
...
//    public void getProgressScore(Sudoku tmpSudoku, List<SolutionStep> stepsTocheck, FindAllStepsProgressDialog dlg) {
    public void getProgressScore(Sudoku tmpSudoku, List<SolutionStep> stepsTocheck) {
...
//        }
        ...
        Sudoku workingSudoku = tmpSudoku.clone();
